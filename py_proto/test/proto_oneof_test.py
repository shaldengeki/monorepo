...
from py_proto.proto_identifier import ProtoFullIdentifier, ProtoIdentifier
...
from py_proto.proto_oneof import ProtoOneOf, ProtoOneOfAdded, ProtoOneOfRemoved
