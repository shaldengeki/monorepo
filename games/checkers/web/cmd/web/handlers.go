...
import (
	...
	serverpb "github.com/shaldengeki/monorepo/games/checkers/proto/server"
	"github.com/shaldengeki/monorepo/games/checkers/server/grpc"
...
func resolveTemplatePath(p string) (string, error) {
	return runfiles.Rlocation(filepath.Join("_main", "games", "checkers", "web", "ui", p))
}
