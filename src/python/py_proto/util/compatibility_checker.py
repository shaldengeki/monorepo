...
from src.python.py_proto.proto_file import ProtoFile
from src.python.py_proto.proto_message import ProtoMessageAdded
from src.python.py_proto.proto_node import ProtoNodeDiff
from src.python.py_proto.util.parser import Parser
