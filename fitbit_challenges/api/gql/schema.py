...
from fitbit_challenges.api.gql.types.bingo_card import bingo_challenge_field, flip_bingo_tile_field
from fitbit_challenges.api.gql.types.challenge import challenges_field, create_challenge_field
from fitbit_challenges.api.gql.types.fitbit_authorization import authorize_with_fitbit_field
